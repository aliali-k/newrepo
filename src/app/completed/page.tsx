  ...
  return (
    <Shell narrow>
      <div className="text-center mb-10">
        <div className="w-14 h-14 rounded-full bg-[var(--accent-soft)] mx-auto mb-5 flex items-center justify-center">
          <div className="w-4 h-4 rounded-full bg-[var(--accent)]" />
        </div>
        <h1 className="text-3xl mb-2">That's a wrap</h1>
      ...
      {!loading && evaluation && (
        <Card className="animate-rise-in">
          <div className="flex items-center justify-between mb-6">
            <div>
              <div className="text-xs text-[var(--text-faint)] mb-1">Overall</div>
              <div className="text-4xl font-[family-name:var(--font-sora)]">
          ...
          {evaluation.strong_topics?.length > 0 && (
            <div className="mt-6 pt-5 border-t border-[var(--border)]">
              <div className="text-xs text-[var(--text-faint)] mb-2">Strong topics</div>
          ...
          {evaluation.reasoning_summary && (
            <p className="text-sm text-[var(--text-muted)] leading-relaxed mt-5 pt-5 border-t border-[var(--border)]">
              {evaluation.reasoning_summary}
            </p>
          )}
        </Card>
      ...
      {!loading && !evaluation && !error && (
        <p className="text-center text-sm text-[var(--text-faint)]">No results found for this session yet.</p>
      )}
